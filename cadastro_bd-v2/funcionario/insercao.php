...
<html>
	<head>
	  <title>Cadastro de funcionário - Inclusão</title>
	  <meta charset="utf-8">
	</head>
	<body>
<?php 
// efetua inclusao do curso informado em cadatro_curso.html
  ...
  if(trim($UF)==""
      ...
      or trim($Data_Nascimento)==""
			...
			echo "Não foi possível cadastrar o Funcionário. Os dados informados são inválidos.";
            ...
            $query = "INSERT INTO funcionario
              ...
              values ('', '$Nome', $CPF, '$Genero', '$Cargo', '$Telefone', '$Email' , 
...
?>  
 <br>
 <a href="index.php">Ver funcionários cadastrados</a>
